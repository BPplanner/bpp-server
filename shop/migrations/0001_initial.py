    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('affiliates', models.ManyToManyField(related_name='_shop_shop_affiliates_+', to='shop.Shop')),
                ('like_users', models.ManyToManyField(blank=True, null=True, related_name='like_shops', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
