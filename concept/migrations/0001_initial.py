    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('like_users', models.ManyToManyField(related_name='like_concepts', to=settings.AUTH_USER_MODEL)),
                ('shop', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='studio_concepts', to='shop.shop')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('profile', models.ImageField(upload_to='')),
                ('shop', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='beautyshop_concepts', to='shop.shop')),
            ],
            options={
                'abstract': False,
            },
