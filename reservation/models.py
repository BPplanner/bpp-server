...
class PickShop(TimeStampMixin):
    ...
    pick_user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='pickshop')
    shop = models.ForeignKey(Shop, on_delete=models.CASCADE, related_name='pickshop')